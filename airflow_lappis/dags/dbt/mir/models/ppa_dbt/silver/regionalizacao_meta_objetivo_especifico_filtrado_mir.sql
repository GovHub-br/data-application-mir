...
inner join programa_filtrado_mir
    on regionalizacao_meta_objetivo_especifico.programa = programa_filtrado_mir.programa
    and regionalizacao_meta_objetivo_especifico.ano_ppa = programa_filtrado_mir.ano_ppa

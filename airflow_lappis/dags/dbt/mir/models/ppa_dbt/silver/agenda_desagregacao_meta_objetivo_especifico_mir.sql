...
inner join programa_mir
    on agenda_desagregacao_meta_objetivo_especifico.programa = programa_mir.programa
    and agenda_desagregacao_meta_objetivo_especifico.ano_ppa = programa_mir.ano_ppa

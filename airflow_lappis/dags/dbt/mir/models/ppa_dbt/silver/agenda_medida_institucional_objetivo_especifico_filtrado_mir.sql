...
inner join programa_filtrado_mir
    on agenda_medida_institucional_objetivo_especifico.programa = programa_filtrado_mir.programa
    and agenda_medida_institucional_objetivo_especifico.ano_ppa = programa_filtrado_mir.ano_ppa

...
with
    medida_institucional_objetivo_especifico_raw as (
        select
        ...
        from {{ source("ppa", "medida_institucional_objetivo_especifico") }}
    )

select *
from medida_institucional_objetivo_especifico_raw

...
with
    agenda_desagregacao_meta_objetivo_especifico_raw as (
        select
        ...
        from {{ source("ppa", "agenda_desagregacao_meta_objetivo_especifico") }}
    )

select *
from agenda_desagregacao_meta_objetivo_especifico_raw

...
with
    agenda_regionalizacao_meta_objetivo_especifico_raw as (
        select
        ...
        from {{ source("ppa", "agenda_regionalizacao_meta_objetivo_especifico") }}
    )

select *
from agenda_regionalizacao_meta_objetivo_especifico_raw
